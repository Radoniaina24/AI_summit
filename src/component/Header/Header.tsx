  ...
  const renderMenuItem = (item: MenuItem, isMobile = false) => {
    ...
    return (
      <div key={item.id} className="relative group">
        <Link
          href={item.href}
          className="flex items-center space-x-2 px-4 py-2.5 text-white hover:text-blue-600 font-medium transition-all duration-200 rounded-lg hover:bg-blue-50 group"
          onMouseEnter={() => hasChildren && setActiveDropdown(item.id)}
        >
          {item.icon && <span className="w-4 h-4">{item.icon}</span>}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <div className="hidden sm:block">
                <h1 className="lg:text-2xl font-bold bg-gradient-to-r from-[#bd47a8] via-[#4f7cda] to-[#a25fbd] bg-clip-text text-transparent">
                  AI Meets Africa
                </h1>
                <p className="text-sm text-center -mt-0.5 bg-gradient-to-r from-[#4f7cda] to-[#a25fbd] bg-clip-text text-transparent">
                  -Summit-
                </p>
              </div>
            </Link>
                  ...
                  className={`hidden lg:inline-flex items-center space-x-2 px-6 py-2.5 rounded-lg font-semibold transition-all duration-200 text-sm
                    ${
                      ctaButton.variant === "secondary"
                        ...
                        : "text-white bg-[#4f7cda]  hover:brightness-100 shadow-md hover:shadow-lg"
                    }`}
                >
                  <span>{ctaButton.label}</span>
                  <ArrowRight className="w-4 h-4" />
      ...
      >
        ...
        >
          ...
          <div className="relative flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/80 flex-shrink-0">
            ...
            <div>
              <h1 className="text-md lg:text-xl font-bold bg-gradient-to-r from-[#bd47a8] via-[#4f7cda] to-[#a25fbd] bg-clip-text text-transparent">
                AI Meets Africa
              </h1>
              <p className="text-sm text-center -mt-0.5 bg-gradient-to-r from-[#4f7cda] to-[#a25fbd] bg-clip-text text-transparent">
                -Summit-
              ...
              <Link
                ...
                className={`flex items-center justify-center space-x-3 px-8 py-5 rounded-2xl font-bold transition-all duration-300 w-full text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] ${
                  ctaButton.variant === "secondary"
                    ...
                    : "text-white bg-[#4f7cda]  hover:brightness-100"
                }`}
                onClick={closeMobileMenu}
              >
                <span>{ctaButton.label}</span>
