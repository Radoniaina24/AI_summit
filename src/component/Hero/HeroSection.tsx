  ...
  return (
    ...
    >
      ...
      <Image
        ...
        alt="Hero background"
        fill // <-- occupe toute la section
        priority // <-- chargement immédiat (important pour un Hero)
        quality={100} // <-- meilleure qualité
        style={{ objectFit: "cover", objectPosition: "center" }}
        className="z-0"
      />
      {/* Background Overlay */}
      {backgroundImage && <div className="absolute inset-0 bg-black/10" />}
